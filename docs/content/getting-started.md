...
$ go get github.com/thienohs/gqlgen
```
...
```bash
$ go run github.com/thienohs/gqlgen init
```
...
And run `go run github.com/thienohs/gqlgen generate`.
...
```go
//go:generate go run github.com/thienohs/gqlgen
```
